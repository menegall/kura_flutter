...
class _PupilDetailPageState extends State<PupilDetailPage> {
  ...
  Future<void> _navigateToAddActivity() async {
    final result = await Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => AddActivityPage(pupil: _pupil),
      ),
    );
    if (result == true) {
      _loadData();
  ...
  Widget build(BuildContext context) {
    ...
    final double rawPercent = _pupil.maxHours > 0 ? (_pupil.workedHours / _pupil.maxHours) : 0.0;
          ...
          : _errorMessage != null
              ...
              : SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Card delle statistiche principali
                      Card(
                        color: Colors.white,
                        elevation: 0,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  const Text('Ore svolte quest\'anno:', style: TextStyle(color: AppColors.blueGrey)),
                                  Text(
                              ...
                              Row(
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      const Text('Tariffa Oraria', style: TextStyle(fontSize: 12, color: AppColors.blueGrey)),
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      const Text('Tariffa Kilometrica', style: TextStyle(fontSize: 12, color: AppColors.blueGrey)),
                                      const SizedBox(height: 4),
                                      Text(
  ...
  Widget _buildActivityItem(Activity activity) {
    ...
    final formattedDate = '${activity.activityDate.day.toString().padLeft(2, '0')}/${activity.activityDate.month.toString().padLeft(2, '0')}/${activity.activityDate.year}';
    return Card(
      color: Colors.white,
            ...
            Wrap(
              ...
              children: [
                if (activity.duration != null)
                  _buildBadge(Icons.access_time, '${activity.duration!.toStringAsFixed(1)} ore'),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(text, style: const TextStyle(fontSize: 11, color: AppColors.blueGrey, fontWeight: FontWeight.w600)),
        ],
      ),
    );
  }
  Widget _buildEmptyState() {
    return Container(
      ...
      child: Column(
        children: [
          const Icon(Icons.assignment_late_outlined, size: 48, color: AppColors.blueGrey),
          const SizedBox(height: 16),
          const Text(
